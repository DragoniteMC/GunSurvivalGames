...
public class GunSGArenaConfig implements ArenaConfig {
    ...
    public Location getLobbyLocation() {
        return gsgConfig.location != null ? Location.deserialize(gsgConfig.location) : null;
    }
    ...
    public CompletableFuture<Boolean> setLobbyLocation(Location location) {
        return CompletableFuture.supplyAsync(() -> {
            gsgConfig.getConfiguration().createSection("lobby-location", location.serialize());
            return gsgConfig.save();
        });
    }
}
